...
const Faq = () => {
  ...
  const [data1, setData] = useState([]), [searchTerm, setSearchTerm] = useState('')
    ...
    <Fragment>
      <Card className='pageBox supplier-screen'>
        <CardBody>
          ...
          {data !== null ? <Faqs data={data1} usertypes={usertypes} searchTerm={searchTerm} setSearchTerm={setSearchTerm} /> : null}
          <FaqContact />
        </CardBody>
      </Card>
    </Fragment>
